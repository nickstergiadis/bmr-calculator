...
export function Widget() {
  ...
  return (
    <div id="top" className="bmr-widget-root min-h-screen bg-slate-50 text-slate-900">
      <main>
        <Hero />
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl bg-white p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-700">
                Pick a realistic calorie target and stick with it for 2-4 weeks
            ...
            <article className="rounded-2xl bg-white p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-700">
                Watch weight trends, energy, hunger, exercise tolerance, and
                recovery instead of relying on a single day.
              </p>
            </article>
            ...
            <article className="rounded-2xl bg-white p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-700">
                Make small adjustments when needed. Sustainable progress usually
                beats aggressive short-term changes.
              </p>
            </article>
          </div>
        </Section>
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-2xl border border-clinical-200 bg-clinical-50 p-5">
              ...
              <ul className="mt-3 grid gap-2 text-sm text-slate-700 sm:grid-cols-2">
                ...
                <li>
                  • Build confidence returning to activity and strength training
                </li>
              </ul>
            </div>
          </div>
