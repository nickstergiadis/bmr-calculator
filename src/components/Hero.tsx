export function Hero() {
  const scrollToSection = (id: string) => {
    const target = document
      .querySelector<HTMLElement>('[data-bmr-calculator]')
  ...
  return (
    <section
      id="hero"
      className="border-b border-slate-200 bg-gradient-to-b from-white to-clinical-50/40 py-12 md:py-14"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl space-y-4">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-clinical-700">
            Educational tool
          </p>
          ...
          <p className="text-base leading-7 text-slate-700 md:text-lg">
            Estimate resting and maintenance calories, then use concise
            rehab-focused guidance to plan movement, nutrition, and progression
            more confidently.
          </p>
          ...
          <div className="flex flex-wrap gap-3 pt-1">
            ...
            <button
              type="button"
              onClick={() => scrollToSection('results-guide')}
